...
screen say(who, what):
    ...
    window:
        id "window"
        ysize 0.2 yalign 0.95 xsize 0.6

        if who is not None:
            window:
                align(0.0,-0.6) # Name box alignment
                id "namebox"
                text who id "who"
        label what id "what" background None text_size 30 align (0.0, 0.2) # Change text_size for normal dialogue
