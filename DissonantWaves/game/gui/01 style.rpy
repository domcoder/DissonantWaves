...
define thm = gui0(
    "#fff", # text color
    "gui/frame/002.png", # frame color or image
    "#fd0", # accent color
...
style default:
    ...
    padding(20,20)
    spacing 10
    font "resources/CrayonLibre.ttf"
    size 36 # Default font size (dialogue is in say.rpy)
    ...
    hover_sound "gui/sfx/select.ogg"
    activate_sound "gui/sfx/click.ogg"
